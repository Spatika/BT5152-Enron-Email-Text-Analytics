...
model.svm  <- train(factor(poi) ~., data = train2, method = "svmLinear", trControl = control)

#Training accuracy 0.85

pred_svm <- predict(model.svm, train2)
mean(pred_svm == scaled_training$poi)


#Testing accuracy 0.77
pred_svm <- predict(model.svm, test2)
mean(pred_svm == scaled_test$poi)
cm = confusionMatrix(pred_svm, scaled_test$poi)

cm$byClass["Precision"] #0.86
