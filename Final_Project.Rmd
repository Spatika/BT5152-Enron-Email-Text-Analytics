...
confusionMatrix(nn_pred_test, test_poi$poi, mode = 'everything') # testing accuracy - 0.8431, prec - 0.925, recall - 0.8043

# AUC
test_pred_nn <- ROCR::prediction(as.numeric(predict(model_nn, test_features_df)), as.numeric(test_poi$poi))
as.numeric(performance(test_pred_nn, "auc")@y.values) # 0.63 auc
