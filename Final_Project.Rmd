...
algos <- c('rf','nnet')
models <- caretList(poi ~ . , data=cbind(train_features_df, train_poi$poi), trControl=control, metric='ROC', methodList=algos)
...
### 3A and 3B models again with engineered features
```{r}
