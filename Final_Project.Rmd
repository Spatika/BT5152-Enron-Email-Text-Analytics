...
grid <- expand.grid(.mtry = c(27, 30, 32, 33))
...
train_cm <- table(predict(rf_model, train_features_df), train_poi$poi)
...
as.numeric(performance(test_pred_rf, "auc")@y.values)
```
